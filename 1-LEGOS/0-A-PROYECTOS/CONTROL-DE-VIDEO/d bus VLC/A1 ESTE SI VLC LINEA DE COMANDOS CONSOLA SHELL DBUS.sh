nooooooooooo
player ctl lo encontre primero aca:
esta completo 
...
VLC bash larguisimo pero completo
...
para MediaPlayer2 en freedesktop.org ver sesion de internet de crome llamada MediaPlayer2
...
para /Applications/VLC.app/Contents/MacOS/VLC --playlist-autostart --no-embedded-video --no-autoscale --video-on-top --width=400 --height=400 ./2013-london-snow.mov

PARA REPRODUCIR Y SALIR BUENO PARA AVISOS
